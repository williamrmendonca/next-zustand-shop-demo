    ...
    <div className="bg-white">
        ...
        <div className="container mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            <div className="hidden w-full text-gray-600 md:flex md:items-center">
              ...
              <span className="mx-1 text-sm">Vila Velha - ES</span>
            </div>
            <div className="w-full">
              <img src="https://d335luupugsy2.cloudfront.net/cms/files/305490/1617902943/$nc769sgzfjg" width="120" alt="Boa Praça" />
            </div>
      ...
      <footer className="bg-gray-200">
        <div className="container mx-auto px-6 py-3 flex justify-between items-center">
          ...
          <p className="py-2 text-gray-500 sm:py-0">Supermercados Boa Praça</p>
        </div>
      </footer>
    </div>
  );
